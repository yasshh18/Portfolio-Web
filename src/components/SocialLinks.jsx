...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://linkedin.com/in/yash-chaurasiya-9730b7286",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@yasshh._.ly",
    icon: Instagram,
    url: "https://www.instagram.com/yasshh._.ly/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@yash",
    icon: Youtube,
    url: "https://www.youtube.com/@yash",
    color: "#FF0000",
...
<a
        ...
        <div className="flex flex-col gap-4">
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="group relative flex items-center gap-4 justify-start p-4 rounded-lg 
                     bg-white/5 border border-white/10 overflow-hidden
                     hover:border-white/20 transition-all duration-500"
          data-aos="fade-up"
          data-aos-delay="100" 

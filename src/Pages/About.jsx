    ...
    >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             A passionate MERN Stack Developer with a background in Computer Network and Telecommunications Engineering. I specialize in building responsive, high-performance web applications using modern technologies like MongoDB, Express.js, React, and Node.js. I’m committed to delivering clean code, smooth UI/UX, and scalable solutions.
            </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "MERN meets AI – accelerating impact, not replacement."
        </blockquote>
      </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="/yash-resume.pdf" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"

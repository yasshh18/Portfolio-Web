...
const techStacks = [
  { icon: "image2.png", language: "C++" },
  { icon: "html.svg", language: "HTML" },
  { icon: "css.svg", language: "CSS" },
  { icon: "image1.png", language: "MongoDB" },
  ...
  const [projects, setProjects] = useState([
    {
      ...
      Description: "Visual tool to understand and compare sorting algorithms with real-time animations and speed control.",
      Img: "/projects/sorting.png",
      Link: "https://yasshh18.github.io/Sorting-visualizer/",
    },
    {
      id: 2,
      Title: "Random Password Generator",
      Description: "Strong and customizable password generator with copy feature.",
      Img: "/projects/password.png",
      Link: "https://yasshh18.github.io/Password-Generator/",
    },
    {
      id: 3,
      Title: "CGPA Calculator – RTU",
      Description: "SGPA/CGPA calculator based on RTU syllabus with semester-wise subject credits.",
      Img: "/projects/cgpa.png",
      Link: "https://yasshh18.github.io/RTU-SGPA-CGPA-CALCULATOR/",
    }
  ]);

  const [certificates, setCertificates] = useState([
    { id: 1, Img: "/certificates/forage ai.png" },
  { id: 2, Img: "/certificates/codsoft.png" },
  { id: 3, Img: "/certificates/infosys.png" },
  { id: 4, Img: "/certificates/microsoft.png" },
  ]);
    ...
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#030014] overflow-hidden" id="Portofolio">
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        <h2 className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-[#6366f1] to-[#a855f7]">
          <span style={{ color: '#6366f1', backgroundImage: 'linear-gradient(45deg, #6366f1 10%, #a855f7 93%)', WebkitBackgroundClip: 'text', backgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Portfolio Showcase</span>
        </h2>

...
const WORDS = ["MERN Stack Developer", "Open Source Contributor"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/yasshh18" },
  { icon: Linkedin, link: "https://linkedin.com/in/yash-chaurasiya-9730b7286" },
  { icon: Instagram, link: "https://www.instagram.com/yasshh._.ly" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                 data-aos="fade-up"
                 data-aos-delay="1000">
                I build responsive, user-friendly full-stack web applications with modern technologies.
                </p>
                ...
                <div className="flex flex-row gap-3 w-full justify-start" data-aos="fade-up" data-aos-delay="1400">
                  ...
                  <CTAButton href="/yash-resume.pdf" text="Resume" icon={ExternalLink} />
                </div>

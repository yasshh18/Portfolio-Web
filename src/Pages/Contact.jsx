...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const formSubmitUrl = 'https://formsubmit.co/yashchaurasiya964@gmail.com';
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%]">
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Have any questions or collaboration ideas? Feel free to send me a message — I’ll get back to you soon!
        </p>
      </div>
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Interested in working together or just want to say hi? Drop a message below!
                </p>
              </div>
